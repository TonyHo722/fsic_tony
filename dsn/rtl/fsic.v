...
wire           axi_awvalid1_s_awvalid;
wire   [11: 0] axi_awaddr_s_awaddr;
wire           axi_wvalid1_s_wvalid;
wire   [31: 0] axi_wdata_s_wdata;
wire    [3: 0] axi_wstrb1_s_wstrb;
wire           axi_arvalid1_s_arvalid;
wire   [11: 0] axi_araddr_s_araddr;
wire           axi_rready1_s_rready;
...
wire           as_aa_tready;
wire   [31: 0] io_as_tdata;
wire    [3: 0] io_as_tstrb;
wire    [3: 0] io_as_tkeep;
wire           io_as_tlast;
wire    [1: 0] io_as_tid;
wire           io_as_tvalid;
wire    [1: 0] io_as_tuser;
wire           as_io_tready;
...
wire           s_tready_as_up_tready;
wire   [31: 0] as_io_tdata;
wire    [3: 0] as_io_tstrb;
wire    [3: 0] as_io_tkeep;
wire           as_io_tlast;
wire    [1: 0] as_io_tid;
wire           as_io_tvalid;
wire    [1: 0] as_io_tuser;
wire           io_as_tready;
wire   [15: 0] serial_rxd;
wire           serial_rclk;
wire           axi_awvalid0_axi_awvalid;
wire           axi_wvalid0_axi_wvalid;
wire    [3: 0] axi_wstrb0_axi_wstrb;
wire           axi_arvalid0_axi_arvalid;
wire           axi_rready0_axi_rready;
wire           cc_la_enable;
wire           la_as_tready_m_tready;
wire   [63: 0] up_la_data;
wire           axi_awvalid2_axi_awvalid;
wire           axi_wvalid2_axi_wvalid;
wire    [3: 0] axi_wstrb2_axi_wstrb;
wire           axi_arvalid2_axi_arvalid;
wire           axi_rready2_axi_rready;
wire           cc_up_enable;
...
wire           up_as_tready_m_tready;
wire   [63: 0] la_up_data;
wire           mb_irq;
wire           user_prj_irq;
wire   [15: 0] serial_txd;
wire           serial_tclk;
wire           axi_clk;
wire           axi_reset_n;
wire           axis_clk;
...
CFG_CTRL #(.pADDR_WIDTH( 12 ),
           .pDATA_WIDTH( 32 )) U_CFG_CTRL0 (
                                            ...
                                            .aa_cfg_araddt  (m_araddr_aa_cfg_araddt),  // I  12
                                            ...
                                            .axi_aready1    (s_arready_axi_aready1),   // I  
                                            ...
                                            .axi_awvalid1   (axi_awvalid1_s_awvalid),  // O  
                                            .axi_awaddr     (axi_awaddr_s_awaddr),     // O  12
                                            .axi_wvalid1    (axi_wvalid1_s_wvalid),    // O  
                                            .axi_wdata      (axi_wdata_s_wdata),       // O  32
                                            .axi_wstrb1     (axi_wstrb1_s_wstrb),      // O  4
                                            .axi_arvalid1   (axi_arvalid1_s_arvalid),  // O  
                                            .axi_araddr     (axi_araddr_s_araddr),     // O  12
                                            .axi_rready1    (axi_rready1_s_rready),    // O  
                                            ...
                                            .axi_awvalid0   (axi_awvalid0_axi_awvalid),// O  
                                            .axi_wvalid0    (axi_wvalid0_axi_wvalid),  // O  
                                            .axi_wstrb0     (axi_wstrb0_axi_wstrb),    // O  4
                                            .axi_arvalid0   (axi_arvalid0_axi_arvalid),// O  
                                            .axi_rready0    (axi_rready0_axi_rready),  // O  
                                            .cc_la_enable   (cc_la_enable),            // O  
                                            .axi_awvalid2   (axi_awvalid2_axi_awvalid),// O  
                                            .axi_wvalid2    (axi_wvalid2_axi_wvalid),  // O  
                                            .axi_wstrb2     (axi_wstrb2_axi_wstrb),    // O  4
                                            .axi_arvalid2   (axi_arvalid2_axi_arvalid),// O  
                                            .axi_rready2    (axi_rready2_axi_rready),  // O  
...
AXIL_AXIS #(.pADDR_WIDTH( 12 ),
            .pDATA_WIDTH( 32 )) U_AXIL_AXIS0 (
                                              ...
                                              .m_awaddr     (m_awaddr_aa_cfg_awaddr),  // O  12
                                              ...
                                              .m_araddr     (m_araddr_aa_cfg_araddt),  // O  12
                                              ...
                                              .s_arready    (s_arready_axi_aready1),   // O  
                                              .s_awvalid    (axi_awvalid1_s_awvalid),  // I  
                                              .s_awaddr     (axi_awaddr_s_awaddr),     // I  12
                                              .s_wvalid     (axi_wvalid1_s_wvalid),    // I  
                                              .s_wdata      (axi_wdata_s_wdata),       // I  32
                                              .s_wstrb      (axi_wstrb1_s_wstrb),      // I  4
                                              .s_arvalid    (axi_arvalid1_s_arvalid),  // I  
                                              .s_araddr     (axi_araddr_s_araddr),     // I  12
                                              .s_rready     (axi_rready1_s_rready),    // I  
...
AXIS_SW #(.pADDR_WIDTH( 12 ),
          .pDATA_WIDTH( 32 )) AXIS_SW0 (
                                        ...
                                        .io_as_tdata  (io_as_tdata),             // I  32
                                        .io_as_tstrb  (io_as_tstrb),             // I  4
                                        .io_as_tkeep  (io_as_tkeep),             // I  4
                                        .io_as_tlast  (io_as_tlast),             // I  
                                        .io_as_tid    (io_as_tid),               // I  2
                                        .io_as_tvalid (io_as_tvalid),            // I  
                                        .io_as_tuser  (io_as_tuser),             // I  2
                                        .as_io_tready (as_io_tready),            // I  
                                        ...
                                        .as_up_tready (s_tready_as_up_tready),   // I  
                                        .as_io_tdata  (as_io_tdata),             // O  32
                                        .as_io_tstrb  (as_io_tstrb),             // O  4
                                        .as_io_tkeep  (as_io_tkeep),             // O  4
                                        .as_io_tlast  (as_io_tlast),             // O  
                                        .as_io_tid    (as_io_tid),               // O  2
                                        .as_io_tvalid (as_io_tvalid),            // O  
                                        .as_io_tuser  (as_io_tuser),             // O  2
                                        .io_as_tready (io_as_tready),            // O  
                                        .la_as_tready (la_as_tready_m_tready),   // O  
                                        ...
                                        .up_as_tready (up_as_tready_m_tready),   // O  
                                        .axi_reset_n  (axi_reset_n),             // I  
                                        .axis_clk     (axis_clk),                // I  
                                        .axis_rst_n   (axis_rst_n)               // I  
                                       );
...
IO_SERDES #(.pADDR_WIDTH( 12 ),
            .pDATA_WIDTH( 32 )) U_IO_SERDES0 (
                                              .io_as_tdata  (io_as_tdata),             // O  32
                                              .io_as_tstrb  (io_as_tstrb),             // O  4
                                              .io_as_tkeep  (io_as_tkeep),             // O  4
                                              .io_as_tlast  (io_as_tlast),             // O  
                                              .io_as_tid    (io_as_tid),               // O  2
                                              .io_as_tvalid (io_as_tvalid),            // O  
                                              .io_as_tuser  (io_as_tuser),             // O  2
                                              .as_io_tready (as_io_tready),            // O  
                                              .as_io_tdata  (as_io_tdata),             // I  32
                                              .as_io_tstrb  (as_io_tstrb),             // I  4
                                              .as_io_tkeep  (as_io_tkeep),             // I  4
                                              .as_io_tlast  (as_io_tlast),             // I  
                                              .as_io_tid    (as_io_tid),               // I  2
                                              .as_io_tvalid (as_io_tvalid),            // I  
                                              .as_io_tuser  (as_io_tuser),             // I  2
                                              .io_as_tready (io_as_tready),            // I  
                                              .serial_rxd   (serial_rxd),              // I  16
                                              .serial_rclk  (serial_rclk),             // I  
                                              .serial_txd   (serial_txd),              // O  16
...
USER_SUBSYS #(.pADDR_WIDTH( 12 ),
              .pDATA_WIDTH( 32 )) U_USER_SUBSYS0 (
                                                  ...
                                                  .s_tready     (s_tready_as_up_tready),   // O  
                                                  .up_la_data   (up_la_data),              // O  64
                                                  .axi_awvalid  (axi_awvalid2_axi_awvalid),// I  
                                                  .axi_awaddr   (axi_awaddr_s_awaddr),     // I  12
                                                  .axi_wvalid   (axi_wvalid2_axi_wvalid),  // I  
                                                  .axi_wdata    (axi_wdata_s_wdata),       // I  32
                                                  .axi_wstrb    (axi_wstrb2_axi_wstrb),    // I  4
                                                  .axi_arvalid  (axi_arvalid2_axi_arvalid),// I  
                                                  .axi_araddr   (axi_araddr_s_araddr),     // I  12
                                                  .axi_rready   (axi_rready2_axi_rready),  // I  
                                                  ...
                                                  .m_tready     (up_as_tready_m_tready),   // I  
                                                  .la_up_data   (la_up_data),              // I  64
                                                  .user_prj_irq (user_prj_irq),            // O  
                                                  .axi_clk      (axi_clk),                 // I  
                                                  .axi_reset_n  (axi_reset_n),             // I  
                                                  .axis_clk     (axis_clk),                // I  
                                                  .axis_rst_n   (axis_rst_n)               // I  
...
MPRJ_IO #(.pADDR_WIDTH( 12 ),
          .pDATA_WIDTH( 32 )) U_MPRJ_IO0 (
                                          .serial_rxd   (serial_rxd),              // O  16
                                          .serial_rclk  (serial_rclk),             // O  
                                          .user_prj_sel (user_prj_sel),            // I  5
                                          .serial_txd   (serial_txd),              // I  16
